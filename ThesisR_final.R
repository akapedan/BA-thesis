...
##Correlation matrix
###Table
correlation.matrix <- cor(df[, ], use = "complete.obs")
...
# Firm growth models
###################################################################
# MODEL SB: y=SalesGrowth, x=Bribes
...
##Histogram
ggplot(df_model1, aes(x=Bribes)) + geom_histogram(binwidth=0.05)
ggplot(df_model1, aes(x=SalesGrowth)) + geom_histogram(binwidth=0.1)
ggplot(df_model1, aes(x=PolicyObstacle)) + geom_histogram(binwidth=0.25)
ggplot(df_model1, aes(x=Export)) + geom_histogram(binwidth=0.2)
ggplot(df_model1, aes(x=Foreign)) + geom_histogram(binwidth=0.2)
...
###Bribes, Note: Even though we remove the upper and lower quantiles the code below removes only the firm which stated to pay 100% of its Sales for Bribes. 
#                Alternatively, deleting this specific row would yield the same result
...
###Diagnostics
par(mfrow=c(2,2))
plot(Model1.1.6) #or autoplot(model)
autoplot(Model1.1.1)

plot(Model1.1.1, 1) #Linearity
plot(df_model1$Bribes, df_model1$SalesGrowth)

plot(Model1.1.1, 2) #Normality
plot(Model1.1.1, 3) #Homoskedasticity
plot(Model1.1.1, 5) #Outliers

cooksd <- cooks.distance(Model1.1.1)
df_model1 %>%
  top_n(3, wt = cooksd)
...
##Histogram
ggplot(df_model1.2, aes(x=SalesGrowth)) + geom_histogram(binwidth=0.1)
ggplot(df_model1.2, aes(x=PolicyObstacle)) + geom_histogram(binwidth=0.25)
ggplot(df_model1.2, aes(x=Export)) + geom_histogram(binwidth=0.2)
ggplot(df_model1.2, aes(x=Foreign)) + geom_histogram(binwidth=0.2)
...
###Diagnostics
par(mfrow=c(2,2))
autoplot(Model1.2.6) #or autoplot(model)
...
##Histogram
ggplot(df_model1.3, aes(x=SalesGrowth)) + geom_histogram(binwidth=0.1)
ggplot(df_model1.3, aes(x=PolicyObstacle)) + geom_histogram(binwidth=0.25)
ggplot(df_model1.3, aes(x=Export)) + geom_histogram(binwidth=0.2)
ggplot(df_model1.3, aes(x=Foreign)) + geom_histogram(binwidth=0.2)
...
###Diagnostics
par(mfrow=c(2,2))
autoplot(Model1.3.6) #or autoplot(model)
plot(df_model1$SalesGrowth, df_model1$Bribes)
...
##Histogram
ggplot(df_model2, aes(x=EmploymentGrowth)) + geom_histogram(binwidth=0.1)
ggplot(df_model2, aes(x=Bribes)) + geom_histogram(binwidth=0.05)
ggplot(df_model2, aes(x=PolicyObstacle)) + geom_histogram(binwidth=0.25)
ggplot(df_model2, aes(x=Export)) + geom_histogram(binwidth=0.2)
ggplot(df_model2, aes(x=Foreign)) + geom_histogram(binwidth=0.2)
...
###Diagnostics
par(mfrow=c(2,2))
autoplot(Model2.1.6) #or autoplot(model)
...
##Histogram
ggplot(df_model2.2, aes(x=EmploymentGrowth)) + geom_histogram(binwidth=0.1)
ggplot(df_model2.2, aes(x=PolicyObstacle)) + geom_histogram(binwidth=0.25)
ggplot(df_model2.2, aes(x=Export)) + geom_histogram(binwidth=0.2)
ggplot(df_model2.2, aes(x=Foreign)) + geom_histogram(binwidth=0.2)
...
###Diagnostics
par(mfrow=c(2,2))
autoplot(Model2.2.6) #or autoplot(model)
plot(df_model1$SalesGrowth, df_model1$Bribes)
...
##Histogram
ggplot(df_model2.3, aes(x=EmploymentGrowth)) + geom_histogram(binwidth=0.1)
ggplot(df_model2.3, aes(x=PolicyObstacle)) + geom_histogram(binwidth=0.25)
ggplot(df_model2.3, aes(x=Export)) + geom_histogram(binwidth=0.2)
ggplot(df_model2.3, aes(x=Foreign)) + geom_histogram(binwidth=0.2)
...
###Diagnostics
par(mfrow=c(2,2))
autoplot(Model2.3.6) #or autoplot(model)
plot(df_model1$SalesGrowth, df_model1$Bribes)
...
##Histogram
ggplot(df_model3, aes(x=LaborProductivityGrowth)) + geom_histogram(binwidth=0.1)
ggplot(df_model3, aes(x=Bribes)) + geom_histogram(binwidth=0.1)
ggplot(df_model3, aes(x=PolicyObstacle)) + geom_histogram(binwidth=0.25)
ggplot(df_model3, aes(x=Export)) + geom_histogram(binwidth=0.2)
ggplot(df_model3, aes(x=Foreign)) + geom_histogram(binwidth=0.2)
...
###Diagnostics
par(mfrow=c(2,2))
autoplot(Model3.1.6) #or autoplot(model)
plot(df_model1$SalesGrowth, df_model1$Bribes)
...
##Histogram
ggplot(df_model3.2, aes(x=LaborProductivityGrowth)) + geom_histogram(binwidth=0.1)
ggplot(df_model3.2, aes(x=PolicyObstacle)) + geom_histogram(binwidth=0.25)
ggplot(df_model3.2, aes(x=Export)) + geom_histogram(binwidth=0.2)
ggplot(df_model3.2, aes(x=Foreign)) + geom_histogram(binwidth=0.2)
...
###Diagnostics
par(mfrow=c(2,2))
autoplot(Model3.2.6) #or autoplot(model)
plot(df_model1$SalesGrowth, df_model1$Bribes)
...
##Histogram
ggplot(df_model3.3, aes(x=LaborProductivityGrowth)) + geom_histogram(binwidth=0.1)
ggplot(df_model3.3, aes(x=PolicyObstacle)) + geom_histogram(binwidth=0.25)
ggplot(df_model3.3, aes(x=Export)) + geom_histogram(binwidth=0.2)
ggplot(df_model3.3, aes(x=Foreign)) + geom_histogram(binwidth=0.2)
...
###Diagnostics
par(mfrow=c(2,2))
autoplot(Model3.3.6) #or autoplot(model)
plot(df_model1$SalesGrowth, df_model1$Bribes)
...
cooksd <- cooks.distance(Model3.1.6)
df_model1 %>%
  top_n(3, wt = cooksd)
#####################################################################
...
##Histogram
ggplot(df_model4, aes(x=InnovationIndex)) + geom_histogram(binwidth=1)
ggplot(df_model4, aes(x=Bribes)) + geom_histogram(binwidth=0.1)
ggplot(df_model4, aes(x=PolicyObstacle)) + geom_histogram(binwidth=0.25)
ggplot(df_model4, aes(x=Foreign)) + geom_histogram(binwidth=0.2)
ggplot(df_model4, aes(x=Export)) + geom_histogram(binwidth=0.2)

xtabs(~ InnovationIndex + Bribes, data=df_model4)
xtabs(~ InnovationIndex + Sector, data=df_model4)
xtabs(~ InnovationIndex + Small, data=df_model4)
xtabs(~ InnovationIndex + Medium, data=df_model4)
xtabs(~ InnovationIndex + Large, data=df_model4)
xtabs(~ InnovationIndex + lnAge, data=df_model4)
xtabs(~ InnovationIndex + lnEperience, data=df_model4)
xtabs(~ InnovationIndex + Foreign, data=df_model4)
xtabs(~ InnovationIndex + Export, data=df_model4)
xtabs(~ InnovationIndex + TrainingEmployees, data=df_model4)
xtabs(~ InnovationIndex + RD, data=df_model4)
xtabs(~ InnovationIndex + QualityCertificate, data=df_model4)
...
logodds <- Model4.1.2$linear.predictors
boxTidwell(logodds ~ Model4.1.2$Bribes)
plot(logodds, Model4.1.2$Bribes)
###confinterval
logistic <- Model4.1.6
confint(logistic)
plot(logistic)
...
###Diagnostics
par(mfrow=c(2,2))
autoplot(Model4.1.1) #or autoplot(model)
plot(df_model1$SalesGrowth, df_model1$Bribes)
...
##Histogram
ggplot(df_model4.2, aes(x=InnovationIndex)) + geom_histogram(binwidth=1)
ggplot(df_model4.2, aes(x=PolicyObstacle)) + geom_histogram(binwidth=0.25)
ggplot(df_model4.2, aes(x=Foreign)) + geom_histogram(binwidth=0.2)
ggplot(df_model4.2, aes(x=Export)) + geom_histogram(binwidth=0.2)
...
##Histogram
ggplot(df_model4.3, aes(x=InnovationIndex)) + geom_histogram(binwidth=1)
ggplot(df_model4.3, aes(x=PolicyObstacle)) + geom_histogram(binwidth=0.25)
ggplot(df_model4.3, aes(x=Foreign)) + geom_histogram(binwidth=0.2)
ggplot(df_model4.3, aes(x=Export)) + geom_histogram(binwidth=0.2)
...
modelX <- c("SalesGrowth", "InformalCompetition", "BribeIndex", "Bribes",
            "PolicyObstacle", "Sector", "Small", "Medium", "Large", "lnAge", "lnExperience", 
            "Foreign", "Export", "RD", "TrainingEmployees")
